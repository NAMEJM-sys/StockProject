...
def ema_calculation1(stockData ,EMA):
    ...
    current_ema100 = EMA.iloc[-1]['EMA_100']
    current_close = stockData.iloc[-1]['close']

    score = 5
    if current_ema100 > current_close:
        score = 7
    elif current_ema100 < current_close:
        score = 3
    else:
        score = 5
...
def ema100_calculation_all(stockData, EMA):
