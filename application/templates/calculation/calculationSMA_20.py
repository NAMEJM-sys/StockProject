...
def sma_calculation1(stockData ,SMA):
    ...
    current_sma20 = SMA.iloc[-1]['SMA_20']
    current_close = stockData.iloc[-1]['close']

    score = 5
    if current_sma20 > current_close:
        score = 7
    elif current_sma20 < current_close:
        score = 3
    else:
        score = 5
...
def sma_calculation2(SMA, period=20):
    sma_trend = SMA['SMA_20'].iloc[-period:].values
...
def sma20_calculation_all(stockData, SMA):
    ...
    current_sma10 = result1.get('SMA_20', None)
