...
def ema_calculation1(stockData ,EMA):
    ...
    current_ema30 = EMA.iloc[-1]['EMA_30']
    current_close = stockData.iloc[-1]['close']

    score = 5
    if current_ema30 > current_close:
        score = 7
    elif current_ema30 < current_close:
        score = 3
    else:
        score = 5
...
def ema30_calculation_all(stockData, EMA):
