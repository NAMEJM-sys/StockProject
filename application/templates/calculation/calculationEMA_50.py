...
def ema_calculation1(stockData ,EMA):
    ...
    current_ema50 = EMA.iloc[-1]['EMA_50']
    current_close = stockData.iloc[-1]['close']

    score = 5
    if current_ema50 > current_close:
        score = 7
    elif current_ema50 < current_close:
        score = 3
    else:
        score = 5
...
def ema50_calculation_all(stockData, EMA):
