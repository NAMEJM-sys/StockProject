...
def sma_calculation1(stockData ,SMA):
    ...
    current_sma30 = SMA.iloc[-1]['SMA_30']
    current_close = stockData.iloc[-1]['close']

    score = 5
    if current_sma30 > current_close:
        score = 7
    elif current_sma30 < current_close:
        score = 3
    else:
        score = 5
...
def sma30_calculation_all(stockData, SMA):
    ...
    current_sma10 = result1.get('SMA_30', None)
